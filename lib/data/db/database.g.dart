    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Animal` (`id` INTEGER, `url` TEXT, PRIMARY KEY (`id`))');
...
class _$AnimalDao extends AnimalDao {
  _$AnimalDao(this.database, this.changeListener)
      : _animalInsertionAdapter = InsertionAdapter(database, 'Animal',
            (Animal item) => <String, dynamic>{'id': item.id, 'url': item.url});
